var Composer = {
  ...
  textareaChanged: function (e) {
    ...
    var regexpResult = str.match(/^d ([a-zA-Z0-9_]+) /), dmString;
    if(regexpResult !== null) {
      ...
      dmString = regexpResult[1].length + 3;
    } else {
      dmString = 0
    }
    var availableChars = MAX_TWEET_SIZE - str.length - this.picTwitterCom + dmString;
  ...
  sendTweet: function () {
    ...
    var regexpResult = message.match(/^d ([a-zA-Z0-9_]+) /);
  ...
  pictureLoaded: function() {
    ...
    if(file == null || file == '') {
      this.picTwitterCom = 0;
    } else {
      this.picTwitterCom = 23;
    }
  },
