  ...
  constructor(token, option) {
    ...
    Object.defineProperties(this, {
      ...
      "token": {
        ...
        set: function(str) {
          this.__token = str || "";
          this.option.saveOption("token", this.__token);
        }
      },
      "tokenRequested": {
        value: false,
...
class GooglShortener extends BaseShortener {
  constructor(token, refresh_token, option) {
    super(token, option);
    Object.defineProperties(this, {
      "__refresh_token": {
        value: refresh_token || "",
      ...
      "refresh_token": {
        ...
        set: function(str) {
          this.__refresh_token = str || "";
          this.option.saveOption("refresh_token", this.__refresh_token);
        }
      },
      "alarmName": {
        get: () => {
    ...
    this.deleteAlarm = ((self) => {
      return (alarms) => {
        ...
        for(let alarm of alarms.entries()) {
...
class Shortener{
  ...
  create(service) {
    switch(service) {
      case 'bit.ly':
        return new BitLyShortener(OptionsBackend.get('shortener_token'), OptionsBackend);
      case 'goo.gl':
        return new GooglShortener(OptionsBackend.get('shortener_token'), OptionsBackend.get('shortener_refresh_token'), OptionsBackend);
      default:
