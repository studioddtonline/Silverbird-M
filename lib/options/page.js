...
$(function() {
  ...
  var onShortenerAcctClick = function() {
    if($("input[name='shortener_acct']").is(':checked')) {
      $("input[name='shortener_login']").removeProp('disabled');
      $("input[name='shortener_key']").removeProp('disabled');
    } else {
      $("input[name='shortener_login']").val('').prop('disabled', 'disabled');
      $("input[name='shortener_key']").val('').prop('disabled', 'disabled');
    }
  };
  ...
  var onSigningUrlCheck = function() {
    ...
    if($check.is(':checked')) {
      $("input[name='base_signing_url'], input[name='base_oauth_signing_url']").prop('disabled', 'disabled');
      ...
      $("input[name='base_signing_url'], input[name='base_oauth_signing_url']").removeProp('disabled');
    ...
    if(!el.is(':checked')) {
      ...
      if(proceed) {
        ...
        if(!sameSigningEl.is(':checked')) {
          sameSigningEl.prop('checked', true).click().prop('checked', true);
        }
      }
    }
    return true;
...
function updatePredictedHitsCount() {
  ...
  TimelineTemplate.eachTimelineTemplate(function(template) {
    ...
    if(!unifiedVisible) {
      inputUnifiedEl.prop('disabled', 'disabled');
    } else {
      inputUnifiedEl.removeProp('disabled');
    }
