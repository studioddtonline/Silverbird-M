    ...
    Object.defineProperties(this, {
      ...
      "_regexp": {
        value: {
          ...
          matchDataURI: new RegExp('^data:image/(jpe?g|png|webp)', 'i'),
    ...
    try {
      ...
      if(doc) {
        ...
        if(thumb) {
          ...
          if(this._regexp.matchDataURI.test(thumb)) {
            // data uri
          } else if(this._regexp.noScheme.test(thumb)) {
