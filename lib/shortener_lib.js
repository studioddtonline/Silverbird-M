...
BitLyShortener = {
  shorten: function(longUrl, callback) {
    ...
    var closure_success = function(self) {
    ...
    .done(closure_success(this))
    .fail(closure_error(this));
  },
  ...
  getAccessToken: function( searchString ) {
    ...
    var success = function(self) {
      return function(data, status) {
        ...
        self.sendRequest( tweetManager.shortenerAuth.longUrl, true, tweetManager.shortenerAuth.callback );
