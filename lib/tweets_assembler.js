  ...
  parseEntities: function(text, entities) {
    ...
    for (i = 0, len = orderedEntities.length; i < len; ++i) {
      ...
      if (entity.type === 'mention') {
        ...
        link.setAttribute('class', 'handleLink');
        link.setAttribute('data-handle-link-base', entity.url);
        link.setAttribute('data-handle-link-expanded', entity.expanded_url);
        link.setAttribute('data-handle-link-media', entity.media_url);
