...
TweetsTimeline.prototype = {
  ...
  giveMeTweets: function(callback, syncNew, cacheOnly, keepCache, suggestedCount) {
    ...
    if(syncNew) {
      ...
      var onFinishCallback = function(self) {
        return function() {
      ...
      this._fetchNewTweets(onFinishCallback(this));
      return;
    }
    ...
    this._doBackendRequest(this.timelinePath, closure_function(this), context, params);
  },
  ...
  _baseInit: function() {
    ...
    this.giveMeTweets(closure_function(this));
  },
