...
Persistence = {
  ...
  init: function() {
    ...
    var existingKeys = ['options', 'selected_lists', 'timeline_order', 'oauth_token_data', 'version', 'popup_size', 'window_position', 'previous_user_id'];
    ...
    for(var i = 0, len = existingKeys.length; i < len; ++i) {
      ...
      this[methodName] = (function(self, key) {
        return function() {
  ...
  cleanupOldData: function() {
    ...
    localStorage.removeItem('oauthTokenService');
  }
};
