var WorkList = {
  bindEvents: function() {
    $(".worklist_container").on('click.popup', ".worklist_cancel_trigger", WorkList.cancelMessage.bind(WorkList));
  },
  ...
  sendFailed: function() {
    ...
    if(!Composer.isVisible()) {
      ...
      Composer.initMessage(topMessage.message, topMessage.replyId, topMessage.replyUser, topMessage.mediaIds, true);
    }
