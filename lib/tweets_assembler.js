...
var Renderer = {
  ...
  renderTweet: function (tweet, useColors) {
    ...
    // tweet space
    var overlayStyle = '', profile_container = '', text_container = '', footer_container = '', newActions_container = '';
    if(!hiddenUserIcons) {
    ...
    var tweetSpace = $($.parseHTML('<div class="tweet_space"><div class="chromed_bird_tweet tweet" timelineid="' + tweetTimeline + '" tweetid="' + tweet.id + '"><div class="tweet_overlay" style="' + overlayStyle + '"><div class="first_container">' + profile_container + '<div class="header_container"></div>' + text_container + footer_container + '</div>' + newActions_container + '</div></div></div>'));
