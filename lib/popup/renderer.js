$.extend(Renderer, {
  assemblyTweets: function (tweets, timelineId) {
    ...
    var doAggressive = (!OptionsBackend.get('compliant_twitter_display_requirements') && OptionsBackend.get('aggressive_flat'));
    ...
    .on('mouseover mouseout click', ".new_actions img", function(event) {
      if(event.type === 'click') {
