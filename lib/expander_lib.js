...
Expander.servicesArray = ['longurl', 'untiny', 'hatena', 'viame', 'fxcamera', 'flickr', 'mobypicture', 'slideshare'];
Expander.services = {
  longurl: {
    expand: function(url) {
  ...
  slideshare: {
    ...
    services: function(url) {
      return ['http://www.slideshare.net/', {}, 'html'];
    },
    parseServices: function(services, data) {
      return $.extend({}, services, {"www.slideshare.net": {slideshare: true}});
    },
    parseExpand: function(data) {
