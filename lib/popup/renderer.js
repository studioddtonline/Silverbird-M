    ...
    $(this).actionMenu({
      ...
      actions: [
        ...
        },
        {
          ...
          condition: function() {
            return !selfId && ($("#compose_tweet_area").css("display") != 'none');
          }
        },
        {
          ...
          condition: function() {
            return !selfId && !(tweetManager.getFollowingIdsMap().has(userId));
          }
        },
        {
        ...
        },
        {
          ...
          condition: function() {
            return !selfId && !(tweetManager.getMutingIdsSet().has(userId));
          },
          second_level: true
        },
        {
        ...
        },
        {
          ...
          condition: function() {
            return !selfId && !(tweetManager.getBlockedIdsSet().has(userId));
          },
          second_level: true
        },
        {
