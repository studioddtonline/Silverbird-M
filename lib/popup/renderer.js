var Renderer = {
  ...
  decideBaseTweet: function(tweet, isRetweet = true, prop = null) {
    ...
    if(baseTweet.hasOwnProperty("extended_tweet")) {
      baseTweet.entities = baseTweet.extended_tweet.entities;
      baseTweet.extended_entities = {
        media: baseTweet.extended_tweet.entities.media
      };
      baseTweet.text = baseTweet.extended_tweet.full_text;
    }
    if(baseTweet.hasOwnProperty("full_text")) {
      baseTweet.text = baseTweet.full_text;
    }
    if(!!prop) {
