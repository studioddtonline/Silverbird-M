...
var Renderer = {
  ...
  renderTweet: function (tweet, useColors, nameAttribute) {
    ...
    if(nameAttribute == "screen_name") {
      ...
      tweetUserName = user.name + ' (@' + user.screen_name + ')';
      tweetTitleUserName = '';
    }
    ...
    if(nameAttribute == "both") {
      userName.appendChild(Renderer.makeText(user.name));
      userName.appendChild(document.createElement('br'));
      userName.appendChild(Renderer.makeText('@' + user.screen_name));
    } else {
    ...
    if(user.verified) {
      headerDiv.appendChild(Renderer.makeText(" "));
      headerDiv.appendChild(Renderer.makeElem("img", {'class':'verified', src:'img/verified.png', alt:'verified'}));
    }
    if(user['protected']) {
      headerDiv.appendChild(Renderer.makeText(" "));
      headerDiv.appendChild(Renderer.makeElem("img", {'class':'protected', src:'img/lock.png', alt:'protected'}));
    }
