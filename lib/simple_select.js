(function($) {
  ...
  $.simpleSelect = function(selectEl, simpleSelectOptions) {
    ...
    if(selectEl.tagName.toUpperCase() != "SELECT") return;
  ...
  $.simpleSelect.prototype = {
    initializeEvents: function() {
      var closure_optionsList = function(self) {
        return function(e) {
          self.selectElement(this.simpleSelectId, true);
        };
      };
      $(this.optionsList.childNodes).click(closure_optionsList(this));

      var closure_selectedLabelImg = function(self) {
        return function(e) {
          $(self.optionsArea).toggle();
        };
      };
      $(this.selectedLabelImg).click(closure_selectedLabelImg(this));

      var closure_document = function(self) {
        return function(e) {
          if(e.target != self.selectedLabelImg) $(self.optionsArea).hide();
        };
      };
      $(document).click(closure_document(this));

      var closure_uiTabsNav = function(self) {
        return function(e) {
          if(e.target != self.selectedLabelImg) $(self.optionsArea).hide();
        };
      };
      $('.ui-tabs-nav li a').click(closure_uiTabsNav(this));
    },
