...
(function($) {
  ...
  $.actionMenu = function(triggerEl, actionMenuOptions) {
    ...
    this.triggerEl.anyClick(closure_function(this));
  };
  ...
  $.actionMenu.prototype = {
    close: function() {
      if(this.visible && !this.closing) {
        ...
        this.actionMenuEl.stop(true, true).effect('puff', {}, 150, closure_function(this));
      }
    },
    ...
    reloadOptions: function() {
      ...
      if(actionsLen === 0) {
        this.actionAreaEl.append($(d.createElement('img')).addClass('action_loading').attr('src', this.options.loading));
      }
      ...
      for(var i = 0; i < actionsLen; ++i) {
        (closure_function(this))(this.actions[i]);
      }
      if(secondLevelUsed) {
        var closure_secondLevel = function(self) {
          return function() {
        ...
        this.secondLevelTrigger.anyClick(closure_secondLevel(this));
      }
      divEl = null;
      imgEl = null;
      aEl = null;
