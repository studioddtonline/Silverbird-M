...
Expander.servicesArray = ['untiny', 'hatena'];
Expander.services = {
  untiny: {
    expand: function(url) {
      return ['http://untiny.me/api/1.0/extract/', {url: url, format: 'json'}];
    },
    services: function() {
      return ['http://untiny.me/api/1.0/services/', {format: 'json'}];
    },
  ...
  hatena: {
    expand: function(url) {
      return ['http://b.hatena.ne.jp/api/htnto/expand', {format: 'json', shortUrl: url}];
    },
    services: function(url) {
      return ['http://b.hatena.ne.jp/api/htnto/expand', {format: 'json'}];
    },
    parseServices: function(services, data) {
