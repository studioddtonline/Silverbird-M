(function($) {
  ...
  $.simpleSelect.prototype = {
    initializeEvents: function() {
      $(this.optionsList.childNodes).click((function(self) {
        return function(e) {
          self.selectElement(this.simpleSelectId, true);
        };
      })(this));

      $(this.selectedLabelImg).click((function(self) {
        return function(e) {
          $(self.optionsArea).toggle();
        };
      })(this));

      $(document).click((function(self) {
        return function(e) {
          if(e.target != self.selectedLabelImg) $(self.optionsArea).hide();
        };
      })(this));

      $('.ui-tabs-nav li a').click((function(self) {
        return function(e) {
          if(e.target != self.selectedLabelImg) $(self.optionsArea).hide();
        };
      })(this));
