  ...
  renderTweet: function (tweet, useColors) {
    ...
    if(this.isComplete() && !hiddenFooter) {
      ...
      if(!hiddenTimestamp) {
        ...
        footer_content += '<span class="timestamp"><a ' + timestamp_option + 'title="' + Renderer.getTimestampAltText(parsedTime) + '" href="' + timestamp_url + '">' + Renderer.getTimestampText(parsedTime) + '</a></span>';
      }
      // reply
