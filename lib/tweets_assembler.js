  ...
  renderTweet: function (tweet, useColors) {
    ...
    if(this.isComplete() && !hiddenFooter) {
      ...
      if(!hiddenGeoInfo && tweet.geo) {
        ...
        footer_content += '<span class="geo_tag"><a class="handleLink tooltip" data-handle-link-noexpand="true" data-handle-link-base="http://maps.google.com/maps?q=loc:' + coords[0] + ',' + coords[1] + ' ' + escape('(' + tweet.user.screen_name + ')') + '" data-tooltip-image="http://maps.google.com/maps/api/staticmap?' + $.param({center: latStr, zoom: 15, size: '200x200', maptype: 'roadmap', markers: 'size:small|' + latStr, sensor: false}) + '" href="#"><img src="data:image/gif;base64, "/></a></span>';
      }
      // from list
