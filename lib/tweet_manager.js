...
function TweetManager() {
  ...
  this.twitterBackend = new TwitterLib(
    function onAuthenticated() {
      ...
      _this.retrieveHitsUpdate();
      _this.retrieveTrendingTopics();
      _this.retrieveSavedSearches();
      /* TODO
       * Lists should retrieve here.
       * but chrome.storage Implimentations and periodic retrieve will need.
       */
      // _this.lists(true);
      StreamListener.start(_this.twitterBackend);
      StreamListener.subscribe(_this.onStreamData, _this);
...
TweetManager.prototype = {
  ...
  */
  ...
  retrieveHitsUpdate: function() {
    ...
    setTimeout(function() { _this.retrieveHitsUpdate(); }, 5 * 60 * 1000);
  },
  ...
  retrieveTrendingTopics: function() {
    var _this = this, woeid = OptionsBackend.get('trending_topics_woeid');
    ...
    setTimeout(function() { _this.retrieveTrendingTopics(); }, 5 * 60 * 1000);
  },
  ...
  retrieveSavedSearches: function(){
    ...
    setTimeout(function() { _this.retrieveSavedSearches(); }, 5 * 60 * 1000);
  },
  ...
  retrieveBearerToken: function() {
    var _this = this, retry = arguments.callee;
    this.twitterBackend.retrieveBearerToken(function(success, data, status, context, request) {
