  ...
  graphCards: {
    ...
    parseExpand: function(data) {
      ...
      var twitterImage = resDoc.querySelector('meta[property=twitter\\:image]')
                      ...
                      || resDoc.querySelector('meta[property=og\\:image]')
                      || resDoc.querySelector('meta[name=og\\:image]')
                      || resDoc.querySelector('meta[class=class\\:image]');
...
Expander.simpleServices = {
  ...
  "vine.co": Expander.services['graphCards'],
