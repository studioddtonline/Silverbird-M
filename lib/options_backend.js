OptionsBackend = {
  defaultOptions: {
    ...
    favorites_refresh_interval: 1800 * 1000,
    ...
    base_search_url: 'https://api.twitter.com/1.1/search/tweets',

    user_stream_url: 'https://api.twitter.com/1.1/user',
    ...
    font_family: '"Hiragino Kaku Gothic ProN", meiryo, Helvetica, Arial, sans-serif',
    font_size: '1.0em',
